            ...
            {!user ? (
              ...
              <div className="flex items-center gap-2 sm:gap-3">
                {(isAdmin || isProblemSetter) ? (
                  <Link href="/dashboard">
                    <Button variant="outline" className="font-bold h-10 rounded-sm px-4 gap-2 text-xs border border-[#8b2626]/40 text-[#8b2626] bg-[#f4ebe0] hover:bg-[#8b2626] hover:text-[#fffdf8] font-serif-ar whitespace-nowrap">
                      <LayoutDashboard className="w-3.5 h-3.5" /> لوحة التحكم
                    </Button>
                  </Link>
                ) : (
                  <Link href="/roadmap">
                    <Button className="font-bold h-10 rounded-sm px-5 text-xs bg-[#8b2626] text-[#fffdf8] hover:bg-[#731b1b] font-serif-ar whitespace-nowrap shadow-sm">
                      مساري التعليمي
                    </Button>
                  </Link>
                )}
                <Button 
                  onClick={logout}
                  variant="ghost" 
                  className="font-bold h-10 rounded-sm px-3 gap-1.5 text-xs text-[#8b2626] hover:bg-[#8b2626]/10 font-serif-ar whitespace-nowrap"
                >
            ...
            <div className="max-w-3xl space-y-6 text-right">
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-2">
                <Link href={user ? "/roadmap" : "/login"}>
                  <Button size="lg" className="font-bold rounded-sm px-8 h-12 text-base bg-[#8b2626] hover:bg-[#731b1b] text-[#fffdf8] border border-[#a83232] shadow-md w-full sm:w-auto font-serif-ar">
                    {user ? "متابعة التعلم" : "ابدأ الآن"}
                  </Button>
                </Link>
                <Link href="/problems">
                  <Button size="lg" variant="outline" className="font-bold rounded-sm px-8 h-12 text-base bg-[#2b221a]/80 text-[#f4ebe0] border border-[#c5a059]/60 hover:bg-[#8b2626] hover:text-[#fffdf8] hover:border-[#8b2626] w-full sm:w-auto font-serif-ar backdrop-blur-sm transition-all">
                    بنك المسائل
                  </Button>
                </Link>
              </div>
